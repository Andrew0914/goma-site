...
Se debe verificar como diferentes partes del sistema de integran entre sí y con elementos externos, como una base de datos y para ello tenemos las pruebas de integración.
...
En este ejemplo que es totalmente explicado: Refactorizando para tener pruebas unitarias valiosas ⭐️, tenemos un pequeño CRM que cumple con los siguientes puntos:
